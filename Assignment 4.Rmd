...
Ans:
  The standard errors of the coefficients are listed income is 4.985e-06 balance is 2.274e-04
...
Ans:
  the boot function coefficient value and income is 2.080898e-05 balance is 5.647103e-03
...
Ans:
  using glm() function for the variable Lag1 and Lag2.
...
Ans:
  using glm() function for the variable Lag1 and Lag2 and include the first column by LOOCV method.
...
Ans:
  This observation was not correctly classified as the true direction is Down.
